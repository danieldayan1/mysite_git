...
urlpatterns = [
    ...
    path('projects/project_react_python_products/',project_react_python_products,name='projects/project_react_python_products'),
    path('projects/sudoku',sudoku,name='sudoku'),
    path('projects/flights',flights,name='flights'),
    path('projects/pictures',pictures,name='pictures')
]
